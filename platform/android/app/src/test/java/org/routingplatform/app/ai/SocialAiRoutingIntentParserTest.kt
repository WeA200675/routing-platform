...
class SocialAiRoutingIntentParserTest {
    ...
    @Test fun bridgeCreatesOnlyDeterministicRequest() {
        ...
        val result = bridge.buildRequest(RoutePoint(48.0, 11.4), "Fahr heim, ohne Autobahn, vorher Supermarkt")
        ...
        assertEquals(NavigationRouteFamily.LowUrban, request.family)
